...
{
    public partial class updatemodel06132020 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonOfTermination = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseOrderId = table.Column<int>(nullable: false),
                    InventoryProductId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrderItems", x => x.PoItemId);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_Inventories_InventoryProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleItems_Inventories_InventoryProductId",
                        column: x => x.InventoryProductId,
                        principalTable: "Inventories",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_InventoryProductId",
